...
onMounted(() => {
  getData()
  setCurrentPageBreadcrumbs('Detail', ['Sekolah', 'Informasi', 'Berita'])
})
      ...
      <div class="page-content">
        <div class="mb-4">
          <div class="d-flex justify-content-between">
            <h2 class="fs-1 fw-bold py-4">Detail Berita</h2>
            <div>
              <router-link :to="'/sekolah/informasi/berita'" class="btn btn-primary d-flex gap-3 align-items-center w-auto">
        ...
        <div>
          <div class="fs-1 fw-bold text-center">
            {{detailData.content_name}} 
            <span class="badge badge-light-primary">{{detailData?.kategori?.cat_name}}</span>
          </div>
